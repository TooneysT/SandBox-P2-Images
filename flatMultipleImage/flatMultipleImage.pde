...
pic1 = loadImage("canada-in-pictures-beautiful-places-to-photograph-morraine-lake.jpg"); //Dimensions: 730 width, 485 height
pic2 = loadImage("20200429211042-GettyImages-1164615296.jpeg"); //Dimensions: 2000 width, 1333 height
//
